...
module.exports.run = async (client, message, args) => {
  ...
  if (!v11Kod) {
    ...
    .setColor(`#66c4a6`)
    .setAuthor(`Uslu v11tov12 Sistemi`, client.user.avatarURL())
    .setDescription(
      `\`\`\`diff
v12 Çevirmek İçin Kod Gir Örnek: u!v11tov12 <KOD>\`\`\``
      )
    .setFooter(`Uslu v11tov12 Sistemi`, client.user.avatarURL())
    );
  }
  if (v11Kod.length > 10000) {
    return message.channel.send(
      "Kodun 10000 Karakterden Fazla Bölerek Yazarmısın ?"
    );
  }
  let v12kod = v11Kod
    .split("get")
...
${v12kod}\`\`\` `
  ...
  message.channel.send(   `:outbox_tray: V12 Kod:`,
      `   \`\`\`js
${v12kod}\`\`\` `)
