...
return message.channel.send(nn.setTitle(`İşte bu kadar!`).setColor('#66c4a6').setDescription(`Spam kısıtlaması başarıyla kapatıldı.`)).then(a => a.delete({timeout: 10000}));
