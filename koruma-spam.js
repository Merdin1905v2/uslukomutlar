...
data.set(`spam.${message.guild.id}`, 'uslu');
return message.channel.send(nn.setTitle(`İşte bu kadar!`).setColor('#66c4a6').setDescription(`Spam kısıtlaması başarıyla açıldı.`)).then(a => a.delete({timeout: 10000}));
